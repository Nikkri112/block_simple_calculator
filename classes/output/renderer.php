...
class renderer extends \plugin_renderer_base{
    ...
    public function render_calculator($results) {
        $renderable = new quiz_results($results);
        return $this->render_from_template('block_simple_calculator/simple_calculator', $renderable->export_for_template($this));
    }
}